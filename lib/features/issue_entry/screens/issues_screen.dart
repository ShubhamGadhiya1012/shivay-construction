...
import 'package:shivay_construction/features/issue_entry/screens/issue_entry_screen.dart';
import 'package:shivay_construction/features/issue_entry/widgets/issue_card.dart';
...
class _IssuesScreenState extends State<IssuesScreen> {
  final IssuesController _controller = Get.put(IssuesController());
          ...
          child: Scaffold(
                        ...
                        child: NotificationListener<ScrollNotification>(
                          onNotification: (scrollNotification) {
                            if (scrollNotification is ScrollEndNotification &&
                              ...
                              _controller.getIssues(loadMore: true);
                            }
                            return false;
                          },
                          child: Obx(() {
            ...
            floatingActionButton: Container(
              ...
              child: FloatingActionButton.extended(
                onPressed: () {
                  Get.to(() => const IssueEntryScreen())?.then((_) {
                    _controller.getIssues();
                  });
                },
