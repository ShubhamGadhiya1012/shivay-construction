// screens/repair_issue_list_screen.dart
...
import 'package:shivay_construction/features/repair_entry/widgets/repair_issue_card.dart';
        ...
        GestureDetector(
          ...
          child: Scaffold(
            ...
            body: RefreshIndicator(
              ...
              color: kColorPrimary,
              onRefresh: () async {
                await _controller.getRepairIssues();
              },
              child: Padding(
                padding: tablet
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(() {
                      if (_controller.repairIssues.isEmpty &&
                        ...
                        child: NotificationListener<ScrollNotification>(
                          onNotification: (scrollNotification) {
                            if (scrollNotification is ScrollEndNotification &&
                              ...
                              _controller.getRepairIssues(loadMore: true);
                            }
                            return false;
                          },
                          child: Obx(() {
                            return ListView.builder(
                              itemCount:
                                  _controller.repairIssues.length +
                                  (_controller.isLoadingMore.value ? 1 : 0),
                              itemBuilder: (context, index) {
                                if (index < _controller.repairIssues.length) {
                                  final issue = _controller.repairIssues[index];
            ...
            floatingActionButton: Container(
              ...
              child: FloatingActionButton.extended(
                onPressed: () {
                  Get.to(() => const RepairEntryScreen());
                },
