...
import 'package:shivay_construction/features/reports/controllers/issue_repair_report_controller.dart';
...
class IssueRepairReportScreen extends StatelessWidget {
  ...
  final IssueRepairReportController _controller = Get.put(
    IssueRepairReportController(),
  );
