...
import 'package:shivay_construction/features/reports/controllers/indent_report_controller.dart';
...
class IndentReportScreen extends StatelessWidget {
  IndentReportScreen({super.key});

  final IndentReportController _controller = Get.put(IndentReportController());
