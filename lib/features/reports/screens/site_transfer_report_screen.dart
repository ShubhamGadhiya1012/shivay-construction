...
import 'package:shivay_construction/features/reports/controllers/site_transfer_report_controller.dart';
...
class SiteTransferReportScreen extends StatelessWidget {
  SiteTransferReportScreen({super.key});

  final SiteTransferReportController _controller = Get.put(
    SiteTransferReportController(),
  );
