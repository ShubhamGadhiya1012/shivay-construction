...
import 'package:shivay_construction/features/reports/controllers/opening_stock_report_controller.dart';
...
class OpeningStockReportScreen extends StatelessWidget {
  ...
  final OpeningStockReportController _controller = Get.put(
    OpeningStockReportController(),
  );
