...
class TermMasterCard extends StatelessWidget {
  const TermMasterCard({
    super.key,
    required this.term,
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: _buildInfoRow(
                    label: 'Fix',
                    value: term.isFix ? 'True' : 'False',
                    tablet: tablet,
                    valueColor: term.isFix ? kColorPrimary : kColorSecondary,
                  ),
                ),
              ],
            ),
