...
class ItemGroupMasterCard extends StatelessWidget {
  const ItemGroupMasterCard({
    super.key,
  ...
  final ItemGroupMasterDm itemGroup;
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Are you sure you want to delete "${itemGroup.igName}"?',
